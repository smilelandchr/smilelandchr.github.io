...
block.Derivatives.Data = block.Dwork(3).Data / block.Dwork(1).Data * (block.Dwork(4).Data^2 / block.Dwork(2).Data^2 - 1);

%endfunction

function Outputs(block)
  
  block.OutputPort(1).Data = block.Dwork(4).Data * exp(block.ContStates.Data);
